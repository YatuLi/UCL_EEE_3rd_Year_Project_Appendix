...
filename = 'C:\Users\Yatu\Documents\UCL\3rd Year\Project\ONE 1.6\the-one-1.6.0\Yatu''s Files\19_02_2017\Reports\DR1\DDRouter_Scenario_EnergyLevelReport.txt';
delimiter = ' ';
...
DDRouterScenarioEnergyLevelReport = cell2mat(raw);
...
Splitted_DDR_Mat = reshape(DDRouterScenarioEnergyLevelReport(:,2), 195, 48);
PurePedestrainsForDDR = Splitted_DDR_Mat ([4:23 26:45 48:67 70:89 92:111 114: 133 136:155 160:179 180:189], :);
TotalEnergyOfAllPedestrains = sum(PurePedestrainsForDDR);
FinalAnswerOfDDR = TotalEnergyOfAllPedestrains * (1/170);
% to insert the Avgerage Energy in the beginning of the Day
FinalAnswerOfDDR = [10e+03 FinalAnswerOfDDR(1,:)];
% to convert the Average Energy into percentage
PercentFinalAnswerOfDDR = FinalAnswerOfDDR * (1/(10e+03));
