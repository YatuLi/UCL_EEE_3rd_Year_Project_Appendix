...
filename = 'C:\Users\Yatu\Documents\UCL\3rd Year\Project\ONE 1.6\the-one-1.6.0\Yatu''s Files\19_02_2017\Reports\EAER1\EnergyAwareEpidRouter_Scenario_EnergyLevelReport.txt';
delimiter = ' ';
...
EAERScenarioEnergyLevelReport = cell2mat(raw);
...
Splitted_EAER_Mat = reshape(EAERScenarioEnergyLevelReport(:,2), 195, 48);
PurePedestrainsForEAER = Splitted_EAER_Mat ([4:23 26:45 48:67 70:89 92:111 114: 133 136:155 160:179 180:189], :);
TotalEnergyOfAllPedestrains = sum(PurePedestrainsForEAER);
FinalAnswerOfEAER = TotalEnergyOfAllPedestrains * (1/170);
% to insert the Avgerage Energy in the beginning of the Day
FinalAnswerOfEAER = [10e+03 FinalAnswerOfEAER(1,:)];
% to convert the Average Energy into percentage
PercentFinalAnswerOfEAER = FinalAnswerOfEAER * (1/(10e+03));
