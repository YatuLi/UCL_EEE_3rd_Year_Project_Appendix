...
filename = 'C:\Users\Yatu\Documents\UCL\3rd Year\Project\ONE 1.6\the-one-1.6.0\Yatu''s Files\19_02_2017\Reports\ER1\EpidRouter_Scenario_EnergyLevelReport.txt';
delimiter = ' ';
...
ERScenarioEnergyLevelReport = cell2mat(raw);
...
Splitted_ER_Mat = reshape(ERScenarioEnergyLevelReport(:,2), 195, 48);
PurePedestrainsForER = Splitted_ER_Mat ([4:23 26:45 48:67 70:89 92:111 114: 133 136:155 160:179 180:189], :);
TotalEnergyOfAllPedestrains = sum(PurePedestrainsForER);
FinalAnswerOfER = TotalEnergyOfAllPedestrains * (1/170);
% to insert the Avgerage Energy in the beginning of the Day
FinalAnswerOfER = [10e+03 FinalAnswerOfER(1,:)];
% to convert the Average Energy into percentage
PercentFinalAnswerOfER = FinalAnswerOfER * (1/(10e+03));
