...
filename = 'C:\Users\Yatu\Documents\UCL\3rd Year\Project\ONE 1.6\the-one-1.6.0\Yatu''s Files\19_02_2017\Reports\ER2\EpidRouter_Scenario_EnergyLevelReport.txt';
delimiter = ' ';
...
ERScenarioEnergyLevelReportSec = cell2mat(raw);
...
Splitted_ER_MatSec = reshape(ERScenarioEnergyLevelReportSec(:,2), 535, 48);
PurePedestrainsForERSec = Splitted_ER_MatSec ([4:63 66:125 128:187 190:249 252:311 314: 373 376:435 440:499 500:529], :);
TotalEnergyOfAllPedestrainsSec = sum(PurePedestrainsForERSec);
FinalAnswerOfERSec = TotalEnergyOfAllPedestrainsSec * (1/510);
% to insert the Avgerage Energy in the beginning of the Day
FinalAnswerOfERSec = [10e+03 FinalAnswerOfERSec(1,:)];
% to convert the Average Energy into percentage
PercentFinalAnswerOfERSec = FinalAnswerOfERSec * (1/(10e+03));
