...
filename = 'C:\Users\Yatu\Documents\UCL\3rd Year\Project\ONE 1.6\the-one-1.6.0\Yatu''s Files\19_02_2017\Reports\SAW1\SAWRouter_Scenario_EnergyLevelReport.txt';
delimiter = ' ';
...
SAWRouterScenarioEnergyLevelReport = cell2mat(raw);
...
Splitted_SAW_Mat = reshape(SAWRouterScenarioEnergyLevelReport(:,2), 195, 48);
PurePedestrainsForSAW = Splitted_SAW_Mat ([4:23 26:45 48:67 70:89 92:111 114: 133 136:155 160:179 180:189], :);
TotalEnergyOfAllPedestrains = sum(PurePedestrainsForSAW);
FinalAnswerOfSAW = TotalEnergyOfAllPedestrains * (1/170);
% to insert the Avgerage Energy in the beginning of the Day
FinalAnswerOfSAW = [10e+03 FinalAnswerOfSAW(1,:)];
% to convert the Average Energy into percentage
PercentFinalAnswerOfSAW = FinalAnswerOfSAW * (1/(10e+03));
