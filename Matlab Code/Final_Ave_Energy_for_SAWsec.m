...
filename = 'C:\Users\Yatu\Documents\UCL\3rd Year\Project\ONE 1.6\the-one-1.6.0\Yatu''s Files\19_02_2017\Reports\SAW2\SAWRouter_Scenario_EnergyLevelReport.txt';
delimiter = ' ';
...
SAWRouterScenarioEnergyLevelReportSec = cell2mat(raw);
...
Splitted_SAW_MatSec = reshape(SAWRouterScenarioEnergyLevelReportSec(:,2), 535, 48);
PurePedestrainsForSAWSec = Splitted_SAW_MatSec ([4:63 66:125 128:187 190:249 252:311 314: 373 376:435 440:499 500:529], :);
TotalEnergyOfAllPedestrainsSec = sum(PurePedestrainsForSAWSec);
FinalAnswerOfSAWSec = TotalEnergyOfAllPedestrainsSec * (1/510);
% to insert the Avgerage Energy in the beginning of the Day
FinalAnswerOfSAWSec = [10e+03 FinalAnswerOfSAWSec(1,:)];
% to convert the Average Energy into percentage
PercentFinalAnswerOfSAWSec = FinalAnswerOfSAWSec * (1/(10e+03));
