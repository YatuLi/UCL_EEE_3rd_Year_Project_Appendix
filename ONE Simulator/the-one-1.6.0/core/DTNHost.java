...
public class DTNHost implements Comparable<DTNHost> {
	...
	public DTNHost(List<MessageListener> msgLs,
		...
		// A new method created by Yatu, comments about above, the size of net <list> is 1, for each node.
	...
	public void update(boolean simulateConnections) {
		...
		if (simulateConnections) {
			for (NetworkInterface i : net) {
				i.update(); // update() in NetworkInterface
			}
		}
		this.router.update(); // update() in MessageRouter
	}
	...
	private void tearDownAllConnections() {
		for (NetworkInterface i : net) {
			...
			// It gets all of the attributes of 'i' in the collection 'NetworkInterface' and assigns them in to a List.
