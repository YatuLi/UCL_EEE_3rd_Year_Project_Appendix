...
public class SimpleBroadcastInterface extends NetworkInterface {
	...
	public void update() {
		...
		/*  Might be a good place to insert our printing out of scanInterval, in terms of TransmitSpeed, 
		 *  It is read. But only for scanInterval.
		 */
//		 System.out.println(this.getScanInterval());
		// System.out.println(this.getTransmitSpeed());
	}
