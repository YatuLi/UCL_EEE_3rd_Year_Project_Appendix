...
public class EnergyLevelReport extends Report implements UpdateListener {
	...
	// method written by Yatu 
	/* This instanistation causes the trouble about 'can't find setting 'transmitRange'
	 * 
	 */
	 // SimpleBroadcastInterface sb = new SimpleBroadcastInterface(new Settings());
	...
	private void createSnapshot(List<DTNHost> hosts) {
		// methods written by Yatu
//		 write(String.valueOf(sb.getScanInterval()));
