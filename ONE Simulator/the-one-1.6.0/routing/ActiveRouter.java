...
public abstract class ActiveRouter extends MessageRouter {
	...
	// new boolean typed switch added by Yatu, 11/02/2017
	private boolean noEnergyConsumption;
	
	
	// Yatu:  A new method created for calling private 'energy' field in EpidemicRouter
	protected EnergyModel getEnergyModelinActiveRouter (){
		return this.energy;
	}
	...
	public void update() {		
		...
		if (energy != null) {
			//System.out.println("Wish Heaven, Qihui, Bing and Yibo a Roller Year");
			//System.out.println(getHost());
			/* TODO: add support for other interfaces */
			NetworkInterface iface = getHost().getInterface(1);
			// A method created by Yatu to test the connecting activities under the initial method 'isBelowThreshold(double thresholdPercent)'.
			//System.out.println(iface);
			
			// Yatu new method to realise the control of Trams, 11/02/2017
//			if (this.getHost().toString().substring(0, 1).equals("t")){
////				System.out.println("UCL");
////				System.out.println(this.getHost() + "Loser");
//				noEnergyConsumption = true;
//				} else{ 
////					System.out.println(this.getHost().toString().substring(0, 1));
////					System.out.println(this.getHost() + "Bang");
//				noEnergyConsumption = false;
//			}
